...
class BaseOptions():
    ...
    def initialize(self):
        self.parser.add_argument('--tar_size', type=int, default=600,
        ...
        self.parser.add_argument('--rest_rf_iters', type=int, default=500,
                                 help='iteration number of rigid fitting for the remaining frames in video fitting.')
        self.parser.add_argument('--rest_nrf_iters', type=int, default=500,
        ...
        self.parser.add_argument('--nframes_shape', type=int, default=1,
...
class MultiViewFittingOptions(BaseOptions):
    def initialize(self):
        BaseOptions.initialize(self)
        self.parser.add_argument(
            ...
            type=str,
            required=True,
            help='Paths to 3 view images: left middle right'
        )
        ...
        self.parser.add_argument(
            ...
            type=str,
            default=None,
            help='(optional) path to initial id.npy for warm start'
        )
        self.parser.add_argument(
            '--init_tex',
            type=str,
            default=None,
            help='(optional) path to initial tex.npy for warm start'
        )
